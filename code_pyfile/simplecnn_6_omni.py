...
norm = input('Normalization? ')  # percentage scales the data when loading data. One of ['off', 'chan', 'freq', 'chanfreq', 'trial', 'signal']

neurons = [16,32,32]  # neurons of each hidden layer
...
if not testOn:
    f_hist_main = os.path.join('.', 'history', 'simplecnn_6_omni', str(randseed), model_name)
else:
